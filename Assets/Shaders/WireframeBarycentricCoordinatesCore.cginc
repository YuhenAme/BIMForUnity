...
fixed4 frag (v2f i) : SV_Target
{
	...
	float closestNormalizedDistance = 0;

	#if ENABLE_DRAWQUAD
	closestNormalizedDistance = max(normalizedUDistance,normalizedVDistance);
    closestNormalizedDistance = min(closestNormalizedDistance,normalizedUVDiagonalDistance);
	#else
    closestNormalizedDistance = min(normalizedUDistance,normalizedVDistance);
    closestNormalizedDistance = min(closestNormalizedDistance,normalizedUVDiagonalDistance);
	#endif
	
	
	//float closestNormalizedDistance;
	//if(maximumVDistance > maximumUVDiagonalDistance)
	//{
	//	if(maximumVDistance>maximumUDistance)
	//	{
	//		//closestNormalizedDistance = min(normalizedUDistance,normalizedUVDiagonalDistance);
	//		closestNormalizedDistance = min(normalizedUDistance,max(normalizedVDistance,normalizedUVDiagonalDistance));
	//	}
	//	else
	//	{
	//	    //closestNormalizedDistance = min(normalizedVDistance,normalizedUVDiagonalDistance);
	//		closestNormalizedDistance = min(normalizedVDistance,max(normalizedUDistance,normalizedUVDiagonalDistance));
	//	}
	//}
	//else if(maximumUDistance>maximumUVDiagonalDistance)
	//{
	//	//closestNormalizedDistance = min(normalizedVDistance,normalizedUVDiagonalDistance);
	//	closestNormalizedDistance = min(normalizedVDistance,max(normalizedUDistance,normalizedUVDiagonalDistance));
