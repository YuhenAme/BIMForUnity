...
[ExecuteInEditMode]
public class NewWireframeRenderer : MonoBehaviour
{
    public bool ShowBackFaces;
    public Color LineColor = Color.black;
    public bool Shaded;
    public float IsQuad = 0;
    ...
    void UpdateQuad()
    {
        //wireframeRenderer.sharedMaterial.SetFloat("_DrawQuad", IsQuad);
        if (Input.GetKeyDown(KeyCode.I))
        {
            wireframeRenderer.sharedMaterial.EnableKeyword("ENABLE_DRAWQUAD");
        }
        else if (Input.GetKeyDown(KeyCode.O))
        {
            wireframeRenderer.sharedMaterial.DisableKeyword("ENABLE_DRAWQUAD");
        }
    }
